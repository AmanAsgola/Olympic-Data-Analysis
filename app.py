...
st.sidebar.image('https://imgs.search.brave.com/J3SN7xMrdQ42Yz-PKBiOdwPDg0YOEEAbFkIo0sj64WU/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9zdC5k/ZXBvc2l0cGhvdG9z/LmNvbS8xMDExNTE0/LzIxNTkvaS80NTAv/ZGVwb3NpdHBob3Rv/c18yMTU5MTAwMS1z/dG9jay1waG90by1v/bHltcGljLWZsYWcu/anBn')
...
if user_menu == 'Overall Analysis':
    ...
    st.title('Athelete over the year')
    st.plotly_chart(fig)
